...
- [TailwindCSS](https://tailwindcss.com/)
  - Technically a dev dependency, but certainly a core library for the app
...
This is really a `lib` directory equivalent and there is an issue to move the
contents of this directory to the `lib/` directory. Everything within this
directory is a wrapper for a library.
